...
app.put("/user",async(req,res)=>{
    try {
        const datas=await pool.query('UPDATE device_management SET device_id=$1, device_model=$2, device_mac_address=$3, device_firmware_version=$4, description=$5, last_updated_by=$6, device_name=$7 device_status$8 WHERE r_no=$9',[device_id,device_model,device_mac_address,device_firmware_version,description,last_updated_by,device_name,device_status,r_no])
