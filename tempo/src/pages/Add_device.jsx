                ...
                <div className="new_device_content">
                    ...
                    <div className="operating_buttons display-flex padding-loc">
                        ...
                        <div className="save_cancel_btn display-flex">
                            <button type="button" className="btn-loc active-loc btn btn-outline-success" onClick={()=>handleClick()}>Save</button>
                            <button type="button" className="btn-loc inactive-loc btn btn-outline-danger" onClick={handleCancel}>cancel</button>
